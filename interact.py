import bpy
from . draw2d import Draw2D, lerp
...
def from_2d_to_3d_origin(mouse_vector, context, clamp=None):
    region = context.region
    rv3d = context.space_data.region_3d
    return region_2d_to_origin_3d(region, rv3d, mouse_vector[:2], clamp=clamp)
...
def from_2d_to_3d(world_vector, context, depth_location=None):
    region = context.region
    rv3d = context.space_data.region_3d
    return region_2d_to_location_3d(region, rv3d, world_vector, depth_location)
